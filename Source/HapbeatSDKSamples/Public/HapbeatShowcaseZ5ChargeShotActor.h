...
private:
	/** Build the transient 6-entry EventMap (charge_loop / charge_thd / shot_light / shot_heavy / tar_hit_light / tar_hit_heavy). */
	void BuildEventMap();
